...
namespace Str_Queue_21
{
    class Program
    {
        static void Main(string[] args)
        {
            int userMasN = 0;
            string s;
            StreamReader sr = new StreamReader("C:\\Users\\tjuri\\source\\repos\\Str_Queue_21\\Str_Queue_21\\TextFile1.txt");
            s = sr.ReadLine();
